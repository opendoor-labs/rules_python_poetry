# from https://raw.githubusercontent.com/python-poetry/poetry/34ca1657cbd2834d98e3bb99ed76fd2df2e6b3b2/install-poetry.py
...
class Installer:
    ...
    def make_env(self, version: str) -> Path:
        ...
        with temporary_directory() as tmp_dir:
            # TODO: install a specific version of virtualenv
            subprocess.call(
